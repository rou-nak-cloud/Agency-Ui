...
const Footer = ({theme}) => {
  ...
  return (
    <>
     <div className='bg-slate-100 dark:bg-gray-900 pt-5 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-12 lg:px-24 xl:px-40'>
        {/* Footer top */}
        ...
        {/* Footer bottom */}
          <div className='pb-6 text-sm text-gray-500 flex justify-center items-center sm:justify-between gap-4 flex-wrap'>
