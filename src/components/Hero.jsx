  ...
  return (
    <>
     <div id='hero' className='flex flex-col items-center gap-6 py-16 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-500'>
        ...
        <div className='inline-flex items-center gap-2 border border-gray-400 p-2 pr-4 rounded-full'>
            <img src={assets.group_profile} alt="group" className='w-20' />
            <p className='text-xs font-medium'>Trusted by 8k+ people</p>
        </div>
        <h1 className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[90px] max-w-5xl'>
        ...
        <p className='text-sm sm:text-lg font-medium text-gray-600 dark:text-white/80 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.</p>
